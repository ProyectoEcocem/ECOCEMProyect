    ...
    public partial class InicialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Herramientas", x => x.HerramientasId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UbicacionSede = table.Column<string>(type: "text", nullable: false),
                    EmpresaId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrabajadorId = table.Column<int>(type: "integer", nullable: false),
                    FechaId = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UnidadMedidaU = table.Column<string>(type: "text", nullable: false),
                    CantidadU = table.Column<int>(type: "integer", nullable: false),
                    Precio = table.Column<double>(type: "double precision", nullable: false),
                    ValeAlmacen = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "HerramientasId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TrabajadorId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    NombreTrabajador = table.Column<string>(type: "text", nullable: false),
                    SedeId = table.Column<int>(type: "integer", nullable: false),
                    Discriminator = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HerramientaMantNecesario_Herramientas_HerramientasId",
                        column: x => x.HerramientasId,
                        principalTable: "Herramientas",
                        principalColumn: "HerramientasId",
                        onDelete: ReferentialAction.Cascade);
